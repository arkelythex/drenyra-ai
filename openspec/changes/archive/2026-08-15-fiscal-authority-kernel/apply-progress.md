...
| journal/**tests**/journal.test.ts | new | 101 |
...
| journal/**tests**/journal.test.ts | modified | +177 |
...
| tenant-isolation/**tests**/import-boundaries.test.ts | MODULE_DIRS + APPROVED_TARGETS + journal triangulation | +45/-5 |
| tasks.md | 1 row `- [ ]` -> `- [x]` | 1 |
...
| fiscal/**tests**/candidate-ordering.test.ts | new | 132 |
...
| fiscal/**tests**/candidate-ordering.test.ts | modified | +186 |
| tasks.md | 7 rows `- [ ]` -> `- [x]` | 14 |
...
| tsconfig.json | +1 include entry | 1 |
| tsconfig.build.json | +1 include entry | 1 |
| tenant-isolation/**tests**/import-boundaries.test.ts | MODULE_DIRS + APPROVED_TARGETS + fiscal triangulation | +36/-1 |
...
| policy/**tests**/pe-policy.test.ts | new | 84 |
| wiring (root index.ts, package.json, tsconfig.json, tsconfig.build.json) | +1 additive line each | 4 |
| tenant-isolation/**tests**/import-boundaries.test.ts | MODULE_DIRS + APPROVED_TARGETS + policy triangulation | +32/-2 |
...
| cdr/index.ts | new | 8 |
| cdr/**tests**/successor.test.ts | new | 149 |
...
| cdr/**tests**/successor.test.ts | extended: 7 new materialization/fail-closed tests + flow updates | +136/-13 |
| cdr/index.ts | unchanged (already exports types + composer) | 0 |
| wiring (root index.ts, package.json, tsconfig.json, tsconfig.build.json) | +1 additive line each | 4 |
| tenant-isolation/**tests**/import-boundaries.test.ts | MODULE_DIRS + APPROVED_TARGETS cdr + triangulation | +34/-6 |
