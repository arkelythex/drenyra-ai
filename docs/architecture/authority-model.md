...
Materiality is derived deterministically from value (BigInt cents), reversibility, and jurisdiction — never from agent claims. See `contracts/candidate.md` → "Materiality policy (draft)":
